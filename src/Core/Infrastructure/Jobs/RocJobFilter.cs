...
public class RocJobFilter : IClientFilter
{
    private static readonly ILog Logger = LogProvider.GetCurrentClassLogger();

    private readonly IServiceProvider _services;

    public RocJobFilter(IServiceProvider services)
    {
        _services = services;
    }
    ...
    public void OnCreating(CreatingContext context)
    {
        ...
        var tenantInfo = scope.ServiceProvider.GetRequiredService<IMultiTenantContextAccessor>().MultiTenantContext
            .TenantInfo;
